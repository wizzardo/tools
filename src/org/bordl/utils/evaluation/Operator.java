...
enum Operator {
    ...
    EQUAL("=", Operator.Requirement.BOTH, -1, false),
    EQUAL2("==", Operator.Requirement.BOTH, 0, true),
    AND("&", Operator.Requirement.BOTH, 5, true),
    AND2("&&", Operator.Requirement.BOTH, 5, true),
    OR("|", Operator.Requirement.BOTH, 5, true),
    OR2("||", Operator.Requirement.BOTH, 5, true),
    NOT("!", Operator.Requirement.RIGHR, 1, true),
    NOT_EQUAL("!=", Operator.Requirement.BOTH, 1, true),
    PLUS_EQUAL("+=", Operator.Requirement.BOTH, -1, false),
    MINUS_EQUAL("-=", Operator.Requirement.BOTH, -1, false),
    MULTIPLY_EQUAL("*=", Operator.Requirement.BOTH, -1, false),
    DIVIDE_EQUAL("/=", Operator.Requirement.BOTH, -1, false),
