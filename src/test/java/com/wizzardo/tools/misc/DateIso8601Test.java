...
public class DateIso8601Test {
    ...
    public void test() {
        ...
        assertEquals(create(2007, 4, 5, 12, 30, 10, 123), parse("2007-04-05T14:30:10.123"));
        assertEquals(create(2007, 4, 5, 14, 30, 10, 0), parse("2007-04-05T14:30:10Z"));
        assertEquals(create(2007, 4, 5, 12, 30, 10, 0), parse("2007-04-05T14:30:10"));
        assertEquals(create(2007, 4, 5, 14, 30, 10, 0), parse("20070405T143010Z"));
        assertEquals(create(2007, 4, 5, 12, 30, 10, 0), parse("20070405T143010"));
        assertEquals(create(2007, 4, 5, 14, 30, 0, 0), parse("2007-04-05T14:30Z"));
        assertEquals(create(2007, 4, 5, 12, 30, 0, 0), parse("2007-04-05T14:30"));
        assertEquals(create(2007, 4, 5, 14, 30, 0, 0), parse("20070405T1430Z"));
        assertEquals(create(2007, 4, 5, 12, 30, 0, 0), parse("20070405T1430"));
        assertEquals(create(2007, 4, 5, 14, 0, 0, 0), parse("2007-04-05T14Z"));
        assertEquals(create(2007, 4, 5, 12, 0, 0, 0), parse("2007-04-05T14"));
        assertEquals(create(2007, 4, 5, 14, 0, 0, 0), parse("20070405T14Z"));
        assertEquals(create(2007, 4, 5, 12, 0, 0, 0), parse("20070405T14"));
    ...
    public void testFormat() {
        ...
        assertEquals("2007-04-05T19:00:10.123+0200", format(parse(s), TimeZone.getTimeZone("Europe/Berlin")));
    }
}
